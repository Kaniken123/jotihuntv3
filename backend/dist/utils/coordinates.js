...
exports.rdToWgs84 = rdToWgs84;
exports.validateRDCoordinates = validateRDCoordinates;
exports.parseRDCoordinates = parseRDCoordinates;
exports.formatRDCoordinates = formatRDCoordinates;
 ...
 */
function validateRDCoordinates(rd) {
    return (rd.x >= 10000 && rd.x <= 280000 &&
 ...
 */
function parseRDCoordinates(input) {
 ...
 */
function formatRDCoordinates(rd) {
